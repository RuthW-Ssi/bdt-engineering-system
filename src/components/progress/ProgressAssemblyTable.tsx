              ...
              return (
                <tr
                  ...
                  style={{
                    ...
                    background: selectedAssemblyId === r.assembly_id ? '#FEF6F6' : undefined,
                  }}
                >
                  ...
                  <td style={td}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 84 }}>
                      ...
                      <span style={{ fontFamily: 'IBM Plex Mono, ui-monospace, monospace', fontSize: 11.5, fontWeight: 700, width: 34, textAlign: 'right' }}>{r.pct}%</span>
                    </div>
                  </td>
                  <td style={{ ...td, textAlign: 'center' }}>
                    {matched ? (
                      <button
                        ...
                        title="Isolate this mark in the 3D view"
